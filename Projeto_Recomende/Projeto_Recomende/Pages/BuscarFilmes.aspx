        ...
        <ContentTemplate>
            <div style="background-color: #D3D3D3; width: 500px; margin-left: auto; margin-right: auto;
                ...
                <div>
                    ...
                    <asp:Button ID="bntBuscar" runat="server" Text="Buscar Filme" OnClick="bntBuscar_Click" />
                    <br /><asp:Label ID="lblMensagem" runat="server" ForeColor="Red"></asp:Label>
                </div>
                <br />
                <div id="filtroAvancado" style="border-width: 1px; background-color: #CDC9C9; padding: 5px;
                    border-style: solid">
                    <div id="conteudo" style="width: 250px; margin-right: auto; margin-left: auto; text-align: left">
                        ...
                        <br />
                        <br />
                        <asp:CheckBox ID="chkDesabilitarFiltroPerfil" Text=" Desabilitar Filtro De Perfil"
                            runat="server" />
                    </div>
                </div>
            </div>
